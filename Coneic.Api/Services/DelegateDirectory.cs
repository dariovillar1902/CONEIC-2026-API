...
internal static class DelegateDirectory
{
        ...
        new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["utn - facultado regional santa fe"] = D("UTN - Facultad Regional Santa Fe",
        ...
        ["utn - facultado regional avellaneda"] = D("UTN - Facultad Regional Avellaneda",
        ...
        ["universidad católica argentina"]    = D("Universidad Católica Argentina",
                                           ("Santiago Meneses",         "3462611376"),
                                           ("Agostina Ingratta",        "2974019956")),
        ["universidad catolicaargentina"]     = D("Universidad Católica Argentina",
                                           ("Santiago Meneses",         "3462611376"),
                                           ("Agostina Ingratta",        "2974019956")),
        ...
        ["utn fr concepción del uruguay"] = D("UTN FR Concepción del Uruguay",
                                           ("Santiago Meneses",         "3462611376"),
                                           ("Agostina Ingratta",        "2974019956")),
        ["utn fr concepcion del uruguay"] = D("UTN FR Concepción del Uruguay",
                                           ("Santiago Meneses",         "3462611376"),
                                           ("Agostina Ingratta",        "2974019956")),

        ["utn fr concordia"]           = D("UTN FR Concordia",
                                           ("Santiago Meneses",         "3462611376"),
                                           ("Agostina Ingratta",        "2974019956")),

        ["utn fr la plata"]            = D("UTN FR La Plata",
                                           ("Santiago Meneses",         "3462611376"),
                                           ("Agostina Ingratta",        "2974019956")),
        ...
        ["un santiago del estero"]     = D("Universidad Nacional de Santiago del Estero",
        ...
        ["unam"]                       = D("Universidad Nacional de Misiones",
                                           ("Estefania Noemi Hundt",    "3751592942"),
                                           ("Nauhel Damian Posnik",     "3755542707")),
        ...
        ["unas"]                       = D("Universidad Nacional de Salta",
                                           ("Luis Fernando Alejandro Barrios", "3874464850"),
                                           ("Gimena Alvarez Matthews",          "3875142818")),
        ...
        ["unaf"]                       = D("Universidad Nacional de Formosa",
                                           ("Joaquín Antonio Rolon",    "3718443595"),
                                           ("Adrian Ezequiel Paz",      "3704721155")),
        ...
        ["unicen"]                     = D("Universidad Nacional del Centro de la Provincia de Buenos Aires",
